...
export default {
  ...
  computed: {
    ...mapState({
      ...
      multipleIdList: state => state.sell.multipleIdList,
  ...
  methods: {
    ...mapMutations({
      ...
      changeGroupName: 'sell/changeGroupName',
      delGoodsGroup: 'sell/delGoodsGroup',
      ...
      dragGroupOrder: 'sell/dragGroupOrder',
    }),

    ...mapActions({
      asyncGetEditGoodsAsync: 'sell/asyncGetEditGoodsAsync',
    }),
    ...
    saveBatchEdit() {
      ...
      this.$api['sell/sell/updateGoodsShow']({
        ...
        this.changeBatchEdit(false);
        this.asyncGetEditGoodsAsync(this).then((res) => {
    ...
    delGroup(group) {
      const currentDel = this.filtGoodsList[group.GroupID] || [];
      let tips = '删除该分组，是否继续?';
